            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" action="proses.php?admin=change_item" method="post">
					            <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">From<span class="required">*	</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="item" class="form-control col-md-7 col-xs-12" name="from" >
                            <?php
                              include "koneksi.php";
                              $no=0;
                              $qr = mysql_query("select * from tbl_item");
                            ...
                            ?>
					            ...
					            <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">To<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="item" class="form-control col-md-7 col-xs-12" name="to">
                            <?php
                              include "koneksi.php";
                              $no=0;
                              $qr = mysql_query("select * from tbl_item");
                      ...
                      <div class='form-group'>
                        <label class='control-label col-md-3 col-sm-3 col-xs-12'>PIC <span class='required'>*</span>
                        </label>
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='birthday' class='date-picker form-control col-md-7 col-xs-12' type='text' readonly name='pic' value='$b[id]'>
                        </div>
                      </div>";
                      ?>
