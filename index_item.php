                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <a href="insert_item.php"><div class="pull-right"><button type="button" class="btn btn-primary btn-sm" style="height:34px;">Insert New Item</button></div></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                          $sql=mysql_query("select * from tbl_item");
                          while($a=mysql_fetch_array($sql)){
                            echo"
                              <tr>
                                <td style='vertical-align: middle'>$a[item]</td>
                                <td style='vertical-align: middle'>$a[size]</td>
                                <td style='vertical-align: middle'>$a[qty]</td>
                                <td style='vertical-align: middle'>
                                  <center>
                                    <a href='update_item.php?a=beranda&id=$a[id]' title='Edit'>
                                      <button type='button' class='btn btn-icon btn-primary' style='width: 40px'><i class='fa fa-edit'></i></button>
                                    </a>
                                    <a href='proses.php?admin=delete_item&id=$a[id]' title='Delete'>
                                      <button type='button' class='btn btn-icon btn-danger' style='width: 40px'><i class='fa fa-trash'></i></button>
                                    </a>&nbsp
									<a href='item_in.php?a=beranda&id=$a[id]' title='Add Stock'>
                                      <button type='button' class='btn btn-icon btn-primary' style='width: 40px'><i class='fa fa-plus'></i></button>
                                    </a>
                                    <a href='item_out.php?a=beranda&id=$a[id]' title='Remove Stock'>
                                      <button type='button' class='btn btn-icon btn-danger' style='width: 40px'><i class='fa fa-minus'></i></button>
                                    </a>
                                  </center>
                                </td>
                              </tr>";
