            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  switch($_GET['a']){
                    case "beranda":
                    $dist = mysql_query("select * from tbl_pic where id='$_GET[id]'");
                    while ($a=mysql_fetch_array($dist))
                    {
                    echo"
                    <form class='form-horizontal form-label-left' action='proses.php?admin=update' method='post' enctype='multipart/form-data'>
                      <input type='hidden' id='number' name='id' data-validate-length-range='6' class='form-control col-md-7 col-xs-12' value='$_GET[id]'>
                      <div class='item form-group'>
                      <label class='control-label col-md-3 col-sm-3 col-xs-12' for='number'>Nik <span class='required'>*</span></label>
                      <div class='col-md-6 col-sm-6 col-xs-12'>
                        <input type='text' id='number' name='nik' required='required' data-validate-length-range='6' class='form-control col-md-7 col-xs-12' value='$a[nik]'>
                      </div>
                      </div>
                      <div class='item form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input id='name' class='form-control col-md-7 col-xs-12' data-validate-length-range='3' data-validate-words='1' name='name' placeholder='Jon Doe' required='required' type='text' value='$a[nama]'>
                        </div>
                      </div>            
                      <div class='item form-group'>
                      ...
                      <div class='item form-group'>
                        <label for='password2' class='control-label col-md-3 col-sm-3 col-xs-12'>Photo Profile</label>
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                      ...
                      <div class='form-group'>
                        <div class='col-md-6 col-md-offset-3'>
                          <a href='index_pic.php'><button type='button' class='btn btn'>Cancel</button></a>
