              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  switch($_GET['a']){
                    ...
                    {
                    echo"
                    <form class='form-horizontal form-label-left' action='proses.php?admin=update_item' method='post'>
                    <input type='hidden' name='id' value='$a[id]'>
					            <div class='item form-group'>
                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='category'>Item Name <span class='required'>*	</span>
                        </label>
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input type='text' id='name' name='name' required='required' data-validate-minmax='10,100' class='form-control col-md-7 col-xs-12' value='$a[item]'>
                        </div>
                      </div>
					            <div class='item form-group'>
                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='number'>Size <span class='required'>*</span>
                        </label>
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                          <input type='number' id='size' name='size' required='required' data-validate-minmax='10,100' class='form-control col-md-7 col-xs-12' value='$a[size]'>
                        </div>
                      </div>
