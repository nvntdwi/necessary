 ...
 <bookmark title="Lettre" level="0" ></bookmark>
    <table style="width: 100%; text-align: center; font-size: 14px; margin-top:20px;">
        <tr>
          ...
          <td style="width:70%">REPORT PEMASUKKAN BARANG </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="style38">Telp:(62-21) 897 1701 Fax: (65-21) 897 1706 </td>
        </tr>
        <tr>
            <td colspan="2"><hr/></td>
        </tr>
...
<table style="background-color:#f4d03f; border: solid 1px grey; margin-top:20px;" border="1" bordercolor="#f4d03f" style="width: 1200px;">
                                    <thead style="text-align:center; height:40px;">
                                        <tr style="background-color:#f39c12; color:white; font-size:16px; padding:5px;">
                                            <th data-sortable='true' style="width:172.5;">Nama Item</th>
											<th data-sortable='true' style="width:172.5;">Stock Masuk</th>
...
<?php			
                    ...
                    $sql=mysql_query("select * from tbl_transaksi where tipe='masuk' ");
