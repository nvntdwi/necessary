                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <a href="insert_pic.php"><div class="pull-right"><button type="button" class="btn btn-primary btn-sm" style="height:34px;">Insert New PIC</button></div></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                          $sql=mysql_query("select * from tbl_pic");
                          while($a=mysql_fetch_array($sql)){
                            echo"
                              <tr>
                                ...
                                <td class='center'>
                                  <center>
								    <a href='update_pic.php?a=beranda&id=$a[id]' class='btn btn-primary'>Edit</a>
                                    <a href='proses.php?admin=delete_pic&id=$a[id]' class='btn btn-danger'>Delete</a>
                                  </center>
                                </td>
                              </tr>";
                          }
